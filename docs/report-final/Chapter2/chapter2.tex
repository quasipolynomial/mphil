...
\begin{figure}[h] 
		...
		\end{scope}
%		\node[fill, draw, circle, minimum width=3pt, inner sep=0pt] at (11,2) {};	
%		\node[fill, draw, circle, minimum width=3pt, inner sep=0pt] at (11.5,2) {};
%		\node[fill, draw, circle, minimum width=3pt, inner sep=0pt] at (12,2) {};
